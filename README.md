...
# :.Opticum.:
__Design:__ Low-rofile keyboard, clip and screen logger, developed entirelly in [PureBasic v5.60 LTS](https://www.purebasic.com/) (also has _alt_ [Boo](https://github.com/boo-lang/boo) version).
