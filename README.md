...
__Usage:__ monitoring and sending scattered logs to pre-defined email address.  
__Extra:__ may vave troubles with future compiler versions due to `SMTP` lib regressions.  
